...
static partial class LoggerExtensions
{
    ...
    [LoggerMessage(EventId = 2, Level = LogLevel.Error, Message = "Path does not exist: {Path}")]
    public static partial void PathDoesNotExist(this ILogger logger, string path);
